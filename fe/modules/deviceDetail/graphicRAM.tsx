...
export default function GraphicRAM({ dataMetrics, totalRam }: { dataMetrics: ChartDataPoint[], totalRam: number }) {
  ...
  return (
    <div id="device-ram-chart-card" className="bg-white rounded-2xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.04)] border border-gray-50">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          <div id="device-ram-chart-icon" className="p-2 bg-purple-50 rounded-xl text-purple-600">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
            </svg>
          </div>
          <h2 id="device-ram-chart-title" className="text-[13px] font-extrabold text-gray-900 tracking-wide">RAM Usage</h2>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div id="device-ram-chart-usage" className="text-xl font-extrabold text-gray-900">{gbUsed} GB</div>
        </div>
      </div>

      <div id="device-ram-chart-scale" className="flex justify-end mb-2">
      ...
      <div id="device-ram-chart-plot" className="w-full h-48 border border-gray-50 rounded-xl overflow-hidden flex items-end bg-[#FAFAFC] relative">
      ...
      <div id="device-ram-chart-footer" className="flex justify-between mt-3 text-[10px] text-gray-400 font-bold tracking-wide uppercase">
