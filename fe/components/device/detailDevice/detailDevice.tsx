...
import GraphicRAM from "@/modules/deviceDetail/graphicRAM";
import GraphicHardisk from "@/modules/deviceDetail/graphicHardisk";
import GraphicCPU from "@/modules/deviceDetail/graphicCPU";
import DeviceInfoCardClient from "../../../modules/deviceDetail/actionsClient";
import DeleteMachineButton from "../../../modules/deviceDetail/buttonDeleteClient";
            ...
            <div className="flex-1">
              ...
              {[...Array(5)].map((_, i) => (
                ...
                >
                  ...
                  <div>60</div>
                  <div>40</div>
                  <div>10:0{(i * 5).toString().padStart(2, "0")}</div>
                </div>
              ))}
            </div>
          </div>
